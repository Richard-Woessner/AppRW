...
const tempData = [
  ...
  },
  {
    ...
    "status": 4,
    "summary": "Stickman needs to get the Sword of Legends to be able to leave his planet that is about to explode.",
    "tags": [
      1,
      268435487,
      268435488
  ...
  },
  {
    ...
    "slug": "cry-baby--1",
    "summary": "Try to get cry baby back to his crip, but be careful to avoid open electric sockets, poisons, fire in the stove. There are things to help along the way such as cookies, lollipops, candy bars and pacifies. If the baby meets any bad guys trying to kidnap him he squeezes the bottle and shoots them.",
    "tags": [
      1,
      17,
      268435464
